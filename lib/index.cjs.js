...
var kind = function (outline) { return function (bg, color) {
...
var getScale = function (_a) {
    var _b = _a.scale, scale = _b === void 0 ? 'normal' : _b;
    return scales[scale];
};
var getKind = function (_a) {
    var _b = _a.kind, kind = _b === void 0 ? 'primary' : _b, _c = _a.outline, outline = _c === void 0 ? false : _c;
    return kinds(outline)[kind];
};
var ButtonStyled = newStyled('button')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  ", ";\n  ", ";\n  cursor: pointer;\n  margin: 3px 5px;\n  border: none;\n  border-radius: 3px;\n"], ["\n  ", ";\n  ", ";\n  cursor: pointer;\n  margin: 3px 5px;\n  border: none;\n  border-radius: 3px;\n"])), getKind, getScale);
var Button = function (_a) {
    var children = _a.children, props = __rest(_a, ["children"]);
    return (React__default.createElement(ButtonStyled, __assign({}, props), children));
};
...
var Alert = function (_a) {
    var children = _a.children, kind = _a.kind, rest = __rest(_a, ["children", "kind"]);
    return (React__default.createElement("div", __assign({ style: {
            padding: 20,
            background: kinds$1[kind] || 'white',
            borderRadius: 3,
            color: 'white',
        } }, rest), children));
};
